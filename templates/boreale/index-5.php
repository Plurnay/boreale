        ...
        <h1 class="">
          ...
          <nav>
            ...
            <li><a href="index.php">Home</a>
              ...
              <li  class="current"><a href="index-5.php">Contact</a></li>
            </ul>
...
<!--========================================================
                          CONTENT
=========================================================-->
<section id="content" class="page5">
    <div class="container bord_1 perspective">
      <div class="row mar_t_6 ">
        <div class="grid_12 bord_1 pad_b_8">
        <h3 class='s1'>contact info</h3>
          <div class="pic_bord s2">
      ...
      <div class="row mar_t_6 pad_b_95 perspective">
       <div class="grid_3 s4">
         <h3 >address</h3>
         
          <address class="">
          <em>9870 St Vincent Place,<br>Glasgow, DC 45 Fr 45.</em>
